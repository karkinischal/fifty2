            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form class="form-horizontal form-label-left" method="post" action="classes/addabout.php">
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button name="update" type="submit" class="btn btn-success">Submit</button>
                        </div>
                      </div>
                    </form>
                  </div>
